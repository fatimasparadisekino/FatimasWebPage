...
if ($_POST) {
    ...
    //$emailTo = 'zoraidavega@fatimasparadisekino.com';
    $emailTo = 'fatimas.paradise.kino@gmail.com';
    ...
    if ($clientName != '' && isEmail($clientEmail) && $message != '') {
        ...
        $privatekey = "6LeQOO4SAAAAAENDylt94XwpQ0-Lx6EiNcImAVOQ";
        ...
        if (!$resp->is_valid) {
            ...
            $array['captchaMessage'] = 'CAPTCHA incorrecto.';
        } else {
            // Send email
